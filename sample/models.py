...
class Connection:
    ...
    def __init__(self, host, user, password, database):
        try:
            ...
            query = 'SELECT DISTINCT e.nombre_corto, tp.producto, tp.porcentaje, t.capacidad_operativa FROM tanque_porcentaje tp INNER JOIN estacion e ON tp.id_dbm = e.id_dbm INNER JOIN tanques t ON tp.id_dbm = t.id_dbm WHERE tp.id_producto = t.id_producto;'
